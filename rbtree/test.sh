...
if grep "ft::pair" ./main.cpp > /dev/null
then
	clang++ -Wall -Wextra -Werror -I../utils/ -Iiterators -I../vector/ -I../vector/iterators/ main.cpp -o ft_rb_tree -Ofast
	time ./ft_rb_tree > ft_output
	sed -i '' "s/ft::pair/std::pair/g" ./main.cpp
	sed -i '' "s/ft::make_pair/std::make_pair/g" ./main.cpp
	clang++ -Wall -Wextra -Werror  -I../utils/ -Iiterators -I../vector/ -I../vector/iterators/ main.cpp -o std_rb_tree -Ofast
