...
void map_test_iterators()
{
	...
	a['d'] = 80;
	a['e'] = 100;
	ft::map<char, int>::iterator begin = a.begin();
	ft::map<char, int>::iterator end = a.end();
	ft::map<char, int>::const_iterator cbegin = a.begin();
	ft::map<char, int>::const_iterator cend = a.end();
	begin++;
	cbegin++;
	end--;
	cend--;
